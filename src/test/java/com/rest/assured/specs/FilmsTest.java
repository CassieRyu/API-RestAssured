...
public class FilmsTest {
    ...
    @Test(groups = "films", description = "Assert if more than five high score films returned.[This will fail]")
...
//        setAdminRole();
        ...
        Assert.assertTrue(highScores.size() > 8, "High score films not more than 5");
    }
}
